...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($email_err) && empty($contact_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        $sql = "INSERT INTO user (username,email,contact, password) VALUES (?, ?, ?, ?)";
...
<head>
    ...
    <style type="text/css">
        body{
            background: url("mite2.jpg") no-repeat center center fixed;
...
<body>
    ...
    <div class="container">
        <a class="navbar-brand" href="">MITE Bus</a>
    </div>
    </div><br><br><br><br>
<div class="form">
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form-group <?php echo (!empty($email_err)) ? 'has-error' : ''; ?>"> 
                <label >Email</label>
                  <input type="email" name="email" placeholder="example@gmail.com" class="form-control" value="<?php echo $email; ?>">
